...
/**
 * @author netcloud
 * @date 2022-09-25 23:54:58
 * @email netcloudtec@163.com
 * @description Flink流式计算是有状态的计算，保留历史结果值。
 * 在开发模式下，使用本地集群的CPU CORE作为默认并行度（我的机器是16Core）
 * 可以在程序环境中指定并行度 env.set
 * 指定一个客户端，输入数据 nc -lk 9999
 */
